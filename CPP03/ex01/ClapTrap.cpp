...
/*   Updated: 2023/09/19 19:11:38 by magonzal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap(void) : _name("Unamed"), _hitpoints(100), _energypoints(50), _attackdamage(20), _maxhp(100)
{
	std::cout << "Default constructor called" << std::endl;
}

ClapTrap::ClapTrap(std::string name) : _name(name), _hitpoints(100), _energypoints(50), _attackdamage(20), _maxhp(100)
{
	if(_name.empty())
