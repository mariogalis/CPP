...
/*   Updated: 2023/09/19 19:11:32 by magonzal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap(void) : _name("Unamed"), _hitpoints(100), _energypoints(100), _attackdamage(30), _maxhp(100)
{
	std::cout << "Default constructor called" << std::endl;
}

ClapTrap::ClapTrap(std::string name) : _name(name), _hitpoints(100), _energypoints(100), _attackdamage(30), _maxhp(100)
{
